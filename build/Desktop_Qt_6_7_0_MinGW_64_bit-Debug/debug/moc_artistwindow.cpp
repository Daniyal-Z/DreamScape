...
struct qt_meta_stringdata_CLASSArtistWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSArtistWindowENDCLASS = QtMocHelpers::stringData(
    "ArtistWindow",
    "on_addSong_clicked",
    "",
    "on_ok_clicked",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSArtistWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ArtistWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSArtistWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSArtistWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSArtistWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ArtistWindow, std::true_type>,
        // method 'on_addSong_clicked'
...
void ArtistWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_addSong_clicked(); break;
...
void *ArtistWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSArtistWindowENDCLASS.stringdata0))
